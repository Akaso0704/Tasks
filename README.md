...
```
在浏览器中生成的页面如下:
![生成页面](C:\Users\53067\Desktop\页面.png)

### 3. HTML标签(部分)
|          类别           |     标签      |                             作用                             |
| :---------------------: | :-----------: | :----------------------------------------------------------: |
|      标题(Heading)      |   <h1></h1>| 规定标题的级别. HTML有六个级别的标题, 是多少级标题, 就将h后的数字改成几 |
|                        |<title></title> | 其中为标题内容 |
|     段落(Paragraph)     |    <p></p>    |                        其中为文本内容                        |
|       链接(Link)        |    <a></a>    |                 用于添加链接, 跳转至其他网页                 |
| 水平线(Horizontal line) |     <hr>      |                           划分段落                           |
|    定义(definition)     | <html></html> |              定义文档类型为html, 也被称为根元素              |
|                         | <body></body> |                         定义主体内容                         |
||<head></head>|定义文档信息|
|     字体(Typeface)      |    <b></b>    |                             加粗                             |
|                         |    <i></i>    |                             斜体                             |
| 排版布局 | <div></div> | 类似于矩形框架, 里面可以放置多种内容 |
